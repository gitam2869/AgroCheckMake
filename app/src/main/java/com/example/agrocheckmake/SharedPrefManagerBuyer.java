...
public class SharedPrefManagerBuyer
{
    private static SharedPrefManagerBuyer mInstance;
    ...
    private SharedPrefManagerBuyer(Context context)
    {
        mCtx = context;
    }

    public static synchronized SharedPrefManagerBuyer getInstance(Context context)
    {
        if(mInstance == null)
        {
            mInstance = new SharedPrefManagerBuyer(context);
        }
        return mInstance;
    }

    public boolean userLogin(int id, String email,String fullname,String mobile,String address)
    {
...
//    public boolean registerCustomerCount(String registercount)
//    {
//        SharedPreferences sharedPreferences = mCtx.getSharedPreferences(SHARED_PREF_NAME_1,Context.MODE_PRIVATE);
//        SharedPreferences.Editor editor = sharedPreferences.edit();
//
//        editor.putString(KEY_CUSTOMER_COUNT,registercount);
//        editor.apply();
//
//        return true;
//    }
